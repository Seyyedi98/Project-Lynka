...
const Register = () => {
  ...
  return (
    <main className="flex w-full">
      ...
      <div className="hidden h-full w-full place-items-center text-white lg:grid lg:place-content-center lg:gap-8">
        <h3 className="text-5xl">خوش آمدید</h3>
        <h5 className="">برای ادامه دادن وارد شوید</h5>
      </div>
    </main>
  );
};
