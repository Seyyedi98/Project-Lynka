...
const PhoneFieldWindows95 = (props) => {
  const { phone, textColor = "#000000", font } = props;
  ...
  return (
    <div className="relative w-full">
      <div
        className={cn(`w-full text-wrap py-2`, phone && "cursor-pointer")}
        style={{
      ...
      >
        <div
          ...
          className={cn("text-center font-bold", phone && "hover:underline")}
        >
