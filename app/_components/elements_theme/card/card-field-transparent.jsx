...
const CardFieldTransparent = (props) => {
...
export default CardFieldTransparent;
  ...
  return (
    <>
      <a
        ...
        className={cn(
          `flex h-16 w-full cursor-pointer flex-col items-center justify-center gap-2 border-[3px] border-white p-2 text-lg font-medium text-white shadow-lg`,
  ...
  return (
    <>
      <a
        ...
        rel="noopener noreferrer"
        className={cn(
          `flex h-28 w-full cursor-pointer items-center justify-start gap-4 border-[3px] border-white p-2 px-4 text-lg font-medium text-white shadow-lg`,
          !isLive || (href === "" && "pointer-events-none"),
        )}
      >
        <div
  ...
  return (
    <>
      <a
        ...
        rel="noopener noreferrer"
        className={cn(
          `relative flex h-28 w-full cursor-pointer flex-col items-center justify-center gap-2 overflow-hidden border-[3px] border-white p-2 text-lg font-medium text-white shadow-lg`,
          !isLive || (href === "" && "pointer-events-none"),
        )}
      >
        {imageUrl && (
  ...
  return (
    <>
      <a
        ...
        rel="noopener noreferrer"
        className={cn(
          `flex w-full cursor-pointer flex-col items-start justify-center gap-2 overflow-hidden border-[3px] border-white text-lg font-medium text-white shadow-lg`,
          !isLive || (href === "" && "pointer-events-none"),
          !imageUrl && "h-48",
        )}
      >
