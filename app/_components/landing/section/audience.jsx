...
const slides = [
  {
    ...
    title: "مشتریان و فروش بیشتر در اینستاگرام",
    description:
      "به مشتریان خود اجازه دهید به راحتی با شما ارتباط برقرار کنند و مستقیماً در اینستاگرام پرداخت انجام دهند.",
    cta: "شروع کنید",
  ...
  },
  {
    ...
    title: "درباره خودتان بگویید و محبوب‌تر شوید",
    description:
      "مخاطبان خود را به لینک‌های مهم هدایت کنید: بازدید محتوای خود را افزایش دهید، فروش بلیط و محبوبیت در شبکه‌های اجتماعی را بالا ببرید.",
    cta: "رشد کنید",
  ...
  },
  {
    ...
    title: "خرید را برای مشتری آسان کنید",
    description:
      "همین حالا فروش آنلاین را شروع کنید. یک فروشگاه اینترنتی در 20 دقیقه بدون نیاز به طراح و برنامه‌نویس ایجاد کنید.",
    cta: "فروش را شروع کنید",
    images: ["/images/store-1.png", "/images/store-2.png"],
  },
  {
    id: "everyone",
    categories: ["هنرمندان و علاقه‌مندان"],
    title: "درباره خود، هنر و علایقتان بیشتر بگویید",
    description:
      "موفقیت‌های خود را به اشتراک بگذارید و ترافیک و فالوور بیشتری برای دیگر شبکه‌های اجتماعی جذب کنید.",
    cta: "کارهایتان را نمایش دهید",
